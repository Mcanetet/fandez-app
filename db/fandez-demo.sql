...
-- ============================================================
-- Generado: 2026-08-28T06:06:53.246Z
...
('client_aland', 'client', 'Chat Sofía', 'Asistente de soporte: primero IA, luego socio o pagos/WhatsApp', 11, 1),
...
('provider_mensajes', 'provider', 'Mensajes Sofía', 'Consultas derivadas por Sofía desde clientes', 9, 1)
ON DUPLICATE KEY UPDATE
