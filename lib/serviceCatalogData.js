    ...
    activities: [
      {
        ...
        basePrice: 40000,
        minM2: 100,
        description: 'Proyectos nuevos o remodelación desde 100 m² · Valle Parraguez Paisajismo'
      },
      {
        ...
        basePrice: 40000,
        minM2: 100,
        description: 'Ejecución, nuevas obras o remodelaciones desde 100 m² · Valle Parraguez Paisajismo'
      },
      {
        id: 'jard-mantencion',
        ...
        basePrice: 40000,
        minM2: 100,
        description: 'Condominios, edificios o espacios comunes desde 100 m² · Valle Parraguez Paisajismo'
      }
    ]
  },
  {
...
function isPerM2Activity(activity) {
  return activity?.pricingUnit === 'm2' || activity?.pricingUnit === 'project_m2';
}

function isPerM2Service(serviceId) {
  // Jardinería usa intake Valle Parraguez (evaluación técnica), no cobro por m² online.
