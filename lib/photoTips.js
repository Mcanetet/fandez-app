  ...
  es: {
    ...
    jardineria: {
      ...
      steps: [
        ...
        'Si puedes, incluye una referencia de escala (silla, puerta o persona al fondo).'
      ],
      notes: 'En el detalle indica metros cuadrados, si es interior de condominio o casa, y si hay riego, mascotas o pendientes.'
    },
    default: {
  ...
  en: {
    ...
    jardineria: {
      ...
      steps: [
        ...
        'If you can, include a scale reference (chair, door or person in the background).'
      ],
      notes: 'In the details, add square meters, house vs condo, and whether there is irrigation, pets or slopes.'
    },
    default: {
