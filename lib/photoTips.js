...
const TIPS = {
  es: {
    ...
    jardineria: {
      ...
      steps: [
        'Toma una foto general del patio o jardín para ver el tamaño.',
        'Acerca césped, setos, maleza o la zona que hay que intervenir.',
        'Si es paisajismo, muestra el área completa y referencias de escala.'
      ],
      notes: 'En el detalle indica metros cuadrados. Si es proyecto de paisajismo, completa también estándar, terreno y especies.'
    },
    default: {
