...
const TIPS = {
  es: {
    ...
    pintura: {
      title: 'Cómo fotografiar un trabajo de pintura',
      steps: [
        'Muestra el muro o techo completo con buena luz natural.',
        'Acerca manchas, humedad, descascarado o zonas a retocar.',
        'Si hay color de referencia (lata o muestra), inclúyelo en la foto.'
      ],
      notes: 'En el detalle indica metros aprox., interior/exterior y si hay que reparar yeso o solo pintar.'
    },
    jardineria: {
      title: 'Cómo fotografiar el jardín',
      steps: [
        'Toma una foto general del patio o jardín para ver el tamaño y contexto.',
        'Muestra el área a diseñar, construir o mantener (mín. 100 m² del proyecto).',
        'Si tienes plano digital, adjúntalo en el paso de requerimientos (PDF).'
      ],
      notes: 'Completa el formulario Valle Parraguez: tipo de servicio, comuna/sector, m² y tipo de propiedad.'
    },
    default: {
  ...
  en: {
    ...
    pintura: {
      title: 'How to photograph a painting job',
      steps: [
        'Show the full wall or ceiling with good natural light.',
        'Close-up of stains, moisture, peeling paint or areas to touch up.',
        'If you have a color reference (can or sample), include it in the photo.'
      ],
      notes: 'In the details, add approx. square meters, indoor/outdoor, and if plaster repair is needed or only paint.'
    },
    jardineria: {
      title: 'How to photograph the garden',
      steps: [
        'Take a wide shot of the patio or garden so size is clear.',
        'Close-up of lawn, hedges, weeds or the area that needs work.',
        'For landscaping, show the full area and a scale reference.'
      ],
      notes: 'In the details, add square meters. For a landscaping project, also complete standard, terrain and plant level.'
    },
    default: {
...
const IMAGE_BY_SERVICE = {
  ...
  pintura: '/img/photo-tips/photo-tip-pintura.jpg',
  jardineria: '/img/photo-tips/photo-tip-jardineria.jpg'
};
