...
const JS_BUNDLE_PREFIXES = [
  'js.', 'client.js.', 'client.historial.', 'client.service.', 'client.dashboard.', 'client.guide.', 'client.request.',
  'provider.js.', 'provider.invoice.', 'tecnico.js.', 'status.', 'coverage.', 'error.', 'pwa.', 'trust.', 'call.'
];
...
function resolveLocale(req) {
  ...
  if (cookies.fandez_lang) return normalizeLocale(cookies.fandez_lang);
...
function setLocaleCookie(res, locale, req) {
  ...
  let cookie = `fandez_lang=${encodeURIComponent(locale)}; Path=/; Max-Age=${maxAge}; SameSite=Lax`;
