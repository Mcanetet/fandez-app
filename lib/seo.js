...
function pageCopy(pageId, locale) {
  const es = {
    home: {
      title: 'Fundez — Oficinas y hogares, listos cuando fallan',
      description: 'Cuando algo falla en casa o en la oficina, te enviamos un técnico verificado en Santiago: gasfitería, electricidad, cerrajería y más. Seguimiento en vivo y trato cercano.',
      keywords: 'servicios a domicilio Santiago, técnico verificado, oficinas, hogar, gasfitería, Fundez'
    },
    about: {
      title: 'Quiénes somos — Fundez',
      description: 'Conoce Fundez: plataforma chilena que conecta hogares y oficinas con técnicos y empresas verificadas, con puntualidad, transparencia y trato humano.',
      keywords: 'Fundez Chile, quiénes somos, servicios hogar oficina Santiago'
    },
    register: {
  ...
  const en = {
    home: {
      title: 'Fundez — Offices and homes, ready when things fail',
      description: 'When something fails at home or in the office, we send a verified technician in Santiago: plumbing, electrical, locksmithing and more. Live tracking and a human touch.',
      keywords: 'home office services Santiago, verified technician, Fundez Chile'
    },
    about: {
      title: 'About us — Fundez',
      description: 'Meet Fundez: a Chilean platform connecting homes and offices with verified technicians and companies, with punctuality, transparency and human care.',
      keywords: 'Fundez Chile, about us, home office services'
    },
    register: {
...
function buildJsonLd(pageId, locale) {
  ...
  const org = {
    ...
    logo: {
      '@type': 'ImageObject',
      url: absoluteUrl('/icons/fundez-v5-512.png'),
      width: 512,
      height: 512
    },
    image: absoluteUrl('/icons/fundez-v5-512.png'),
  ...
  const service = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: locale === 'en' ? 'Offices and homes, ready when things fail' : 'Oficinas y hogares, listos cuando fallan',
    ...
    serviceType: locale === 'en'
      ? 'Home and office repair and maintenance'
      : 'Reparación y mantenimiento de hogares y oficinas'
  };
