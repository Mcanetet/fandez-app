...
function pageCopy(pageId, locale) {
  const es = {
    home: {
      title: 'Fandez — Hogares y oficinas, siempre en excelencia',
      description: 'Expertos verificados en Santiago para tu hogar y oficina: gasfitería, electricidad, cerrajería y más. Seguimiento en vivo, precios claros y trato cercano.',
  ...
  const en = {
    home: {
      title: 'Fandez — Homes and offices, always in expert hands',
      description: 'Verified experts in Santiago for your home and office: plumbing, electrical, locksmithing and more. Live tracking, clear pricing and personal service.',
