...
function pageCopy(pageId, locale) {
  const es = {
    home: {
      title: 'Fandez — Oficinas y hogares, listos cuando fallan',
  ...
  const en = {
    home: {
      title: 'Fandez — Offices and homes, ready when things fail',
...
function buildJsonLd(pageId, locale) {
  ...
  const org = {
    ...
    logo: {
      '@type': 'ImageObject',
      url: absoluteUrl('/icons/fandez-v5-512.png'),
      width: 512,
      height: 512
    },
    image: absoluteUrl('/icons/fandez-v5-512.png'),
