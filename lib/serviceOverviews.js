...
const OVERVIEWS = {
  ...
  jardineria: {
    title: L('Jardinería a domicilio', 'Home gardening'),
    subtitle: L('Corte, poda y mantención cobrados por m².', 'Mowing, pruning and upkeep priced per m².'),
    image: '/img/photo-tips/photo-tip-jardineria.jpg',
    imageAlt: L('Servicio de jardinería', 'Gardening service'),
    problems: L(
      ['Corte de césped', 'Desmalezado', 'Poda de setos', 'Jardineras y canteros', 'Mantención integral', 'Plantación / pasto en rollo'],
      ['Lawn mowing', 'Weeding', 'Hedge pruning', 'Planters and beds', 'Full upkeep', 'Planting / sod']
    ),
    includes: L(
      ['Mano de obra según m² informados', 'Evaluación visual del área', 'Retiro básico de recortes en la visita', 'Seguimiento del servicio'],
      ['Labor based on stated m²', 'Visual assessment of the area', 'Basic clipping removal on the visit', 'Service tracking']
    ),
    excludes: L(
      ['Tierra, pasto, plantas y fertilizantes', 'Tala de árboles grandes', 'Sistemas de riego nuevos (se cotizan)'],
      ['Soil, sod, plants and fertilizer', 'Large tree felling', 'New irrigation systems (quoted)']
    ),
    brands: []
  }
};
