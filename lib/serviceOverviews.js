...
const OVERVIEWS = {
  ...
  gasfiter: {
    ...
    subtitle: L('Fugas, destapes, grifería y conexiones de lavadora/lavavajillas.', 'Leaks, clogs, faucets and washer/dishwasher connections.'),
    image: '/img/photo-tips/photo-tip-gasfiter.jpg',
    imageAlt: L('Servicio de gásfiter', 'Plumbing service'),
    problems: L(
      ['Fugas de agua', 'Destape de cañerías', 'Grifería / llaves', 'Sanitario / estanque', 'Ducha o lavamanos', 'Lavadora / lavavajillas (hidráulica)', 'Filtraciones visibles'],
      ['Water leaks', 'Pipe unclogging', 'Faucets / valves', 'Toilet / tank', 'Shower or sink', 'Washer / dishwasher (plumbing)', 'Visible seepage']
    ),
    includes: L(
  ...
  aires: {
    title: L('Aire acondicionado', 'Air conditioning'),
    subtitle: L('Mantención, reparación, recarga e instalación de equipos split.', 'Maintenance, repair, recharge and split install.'),
    image: '/img/photo-tips/photo-tip-aires.jpg',
    imageAlt: L('Aire acondicionado', 'Air conditioning'),
    problems: L(
      ['Mantención y sanitización', 'No enfría / no calienta', 'Fuga de agua / drenaje', 'Recarga de refrigerante', 'Ruido anormal', 'Placa electrónica', 'Instalación split'],
      ['Maintenance and sanitizing', 'Not cooling / heating', 'Water leak / drain', 'Refrigerant recharge', 'Unusual noise', 'Control board', 'Split install']
    ),
    includes: L(
      ['Diagnóstico en domicilio', 'Mano de obra del técnico', 'Prueba de funcionamiento', 'Seguimiento en vivo'],
      ['On-site diagnosis', 'Technician labor', 'Function test', 'Live tracking']
    ),
    excludes: L(
      ['Gas refrigerante, filtros y piezas', 'Equipo nuevo (se cotiza aparte)', 'Obra civil / ductos mayores'],
      ['Refrigerant, filters and parts', 'New unit (quoted separately)', 'Major civil / duct work']
    ),
    brands: ['LG', 'Samsung', 'Midea', 'Daikin', 'Carrier', 'Otras / Other']
  },
  otros: {
    title: L('Otros oficios y electrodomésticos', 'Other trades and appliances'),
    subtitle: L('Electrónica de lavadora/lavavajillas y oficios complementarios.', 'Washer/dishwasher electronics and complementary trades.'),
    image: '/img/photo-tips/photo-tip-lavadora.jpg',
    imageAlt: L('Electrodomésticos y otros oficios', 'Appliances and other trades'),
    problems: L(
      ['Lavadora no centrifuga', 'Tarjeta electrónica', 'Lavavajillas programas erráticos', 'Mantención preventiva', 'Diagnóstico general', 'Ruidos / vibración', 'Códigos de error'],
      ['Washer won’t spin', 'Control board', 'Dishwasher program faults', 'Preventive maintenance', 'General diagnosis', 'Noise / vibration', 'Error codes']
    ),
    includes: L(
      ['Diagnóstico a domicilio', 'Mano de obra del técnico', 'Prueba de funcionamiento', 'Seguimiento en vivo'],
      ['On-site diagnosis', 'Technician labor', 'Function test', 'Live tracking']
    ),
    excludes: L(
      ['Repuestos y piezas', 'Traslado del equipo fuera del domicilio', 'Trabajos fuera del alcance acordado'],
      ['Parts', 'Moving the unit off-site', 'Work outside agreed scope']
    ),
    brands: ['LG', 'Samsung', 'Bosch', 'Whirlpool', 'Fensa', 'Otras / Other']
  },
  electrico: {
  ...
  jardineria: {
    ...
    subtitle: L(
      'Con Valle Parraguez Paisajismo: diseño, construcción o mantención desde 100 m².',
      'With Valle Parraguez Paisajismo: design, construction or upkeep from 100 m².'
    ),
    ...
    problems: L(
      ['Diseño de jardines', 'Construcción de jardines', 'Mantención de jardines', 'Espacios comunes / condominios', 'Remodelación desde 100 m²'],
      ['Garden design', 'Garden construction', 'Garden upkeep', 'Common areas / condominiums', 'Remodel from 100 m²']
    ),
    includes: L(
      ['Captura de requerimientos online', 'Evaluación técnica en terreno', 'Coordinación con Valle Parraguez Paisajismo', 'Seguimiento del servicio en Fandez'],
      ['Online requirements intake', 'On-site technical evaluation', 'Coordination with Valle Parraguez Paisajismo', 'Service tracking in Fandez']
    ),
    excludes: L(
      ['Materiales, plantas y pasto (se cotizan aparte)', 'Tala de árboles grandes', 'Obras fuera del alcance acordado en evaluación'],
      ['Materials, plants and sod (quoted separately)', 'Large tree felling', 'Works outside the post-evaluation scope']
    ),
    brands: []
  },
  limpieza: {
    title: L('Limpieza', 'Cleaning'),
    subtitle: L('Por m² ($1.500). Materiales incluidos. +15% mascotas o post evento.', 'Per m² ($1,500). Materials included. +15% pets or post-event.'),
    image: null,
    imageAlt: L('Servicio de limpieza', 'Cleaning service'),
    problems: L(
      ['Limpieza de hogar / departamento', 'Limpieza de oficina / local', 'Limpieza profunda', 'Post fiesta o evento'],
      ['Home / apartment cleaning', 'Office / shop cleaning', 'Deep cleaning', 'Post-party or event']
    ),
    includes: L(
      ['Mano de obra por m²', 'Materiales de limpieza incluidos', 'Opción mascotas (+15%)', 'Opción post evento (+15%)'],
      ['Labor per m²', 'Cleaning materials included', 'Pets option (+15%)', 'Post-event option (+15%)']
    ),
    excludes: L(
      ['Lavado de alfombras especializadas', 'Desinfección hospitalaria', 'Limpieza de fachadas exteriores en altura'],
      ['Specialized carpet washing', 'Hospital-grade disinfection', 'High exterior facade cleaning']
    ),
    brands: []
  }
};
