...
const IVA_POLICY = {
  ...
  why: [
    ...
    'Internamente Fandez ya aplica IVA 19% solo sobre comisión + fee tarjeta al liquidar al socio; eso es contable, no un recargo extra al cliente.'
  ],
...
const PLAN_A = {
  ...
  highlights: [
    { sku: 'Visita diagnóstico', price: 50000, note: 'Acreditable 100% si el cliente acepta el trabajo' },
...
const AGENDA_WEEKS = [
  {
    ...
    clientIncentives: [
      'Mensaje seed WhatsApp: visita $50 mil acreditable + seguimiento en mapa.',
