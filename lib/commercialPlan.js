...
const IVA_POLICY = {
  ...
  why: [
    'Mayor conversión: el cliente compara cotizar a mano vs app con un solo número.',
    'Cumple la expectativa de precio transparente (SERNAC / práctica retail).',
    'Evita sorpresas al pagar con tarjeta.',
    'Internamente Fandez retiene 15% IVA incluido de la mano de obra más el costo Mercado Pago (valor presente). Eso no se suma al cliente.'
  ],
...
const PLAN_A = {
  ...
  catalogPrices: {
    ...
    // Aire
    'ac-mantencion': 89000,
    'ac-serpentines': 99000,
    'ac-refrigerante': 99000,
    'ac-placa': 115000,
    'ac-instalacion': 170000,
    'ac-drenaje': 99000,
    'ac-ruido': 95000,
    // Termos
    'termo-sarro': 85000,
...
const AGENDA_WEEKS = [
  {
    ...
    clientIncentives: [
      'Mensaje seed: visita $19.990 acreditable + seguimiento en mapa.',
  ...
  },
  {
    ...
    partnerIncentives: [
      ...
      'Si muro vacío >15 min: Aviso broadcast a socios online de esa especialidad.'
    ]
  },
  {
    id: 'w2',
