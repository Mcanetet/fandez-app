...
async function syncKnowledgeFromApp(appStore) {
  ...
  const attentionBlock = [
    'Procedimiento de atención Fandez (nivel europeo) — socio y técnico:',
    '1. Puntualidad o aviso proactivo de demora.',
    '2. Presentación: nombre completo y mención a Fandez.',
    ...
    'Sofía acompaña al cliente en cada hito (pago, búsqueda, asignación, en camino, en sitio, presupuesto, completado).',
    'El canal de soporte operativo es Sofía en la app.'
  ].join('\n');
