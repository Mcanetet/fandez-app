...
const JOURNEY_COPY = {
  ...
  materials_purchase: (r, extra = {}) =>
    `El técnico pide OK para comprar material adicional${extra.amount ? ` (~${formatCLP(extra.amount)})` : ''}${extra.description ? `: ${extra.description}` : ''}. Materiales bajo $10.000 van incluidos; desde $10.000 se cobran a costo. Aprueba o rechaza en la app.`,
