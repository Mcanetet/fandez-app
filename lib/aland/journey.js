...
const JOURNEY_COPY = {
  payment_searching: (r) =>
    `Pago confirmado. Estamos buscando un socio verificado para tu servicio de ${r.serviceName}. Esto puede tomar hasta unos 15 minutos; te avisaré aquí en cuanto haya novedades.`,
  provider_assigned: (r) =>
