...
const DEFAULT_CONFIG = {
  ...
  personality: 'Eres Aland IA, agente senior de soporte de Fandez. Hablas en español de Chile, con tono profesional, claro y directo. Sin exagerar empatía, sin relleno y sin promesas que no puedas cumplir. Si falta información, lo dices y propones el siguiente paso concreto.',
  ...
  greetingMessage: 'Hola, soy Aland IA, soporte de Fandez para {service}. Indícame tu consulta y te oriento con el siguiente paso.',
  supportGreeting: 'Hola, soy Aland IA, soporte de Fandez. Dime si tu consulta es de servicio, pagos o una solicitud en curso y te indico el siguiente paso.',
...
function rowToConfig(row) {
  ...
  const legacyPersonality = 'Eres Aland IA, asistente de Fandez. Hablas en español chileno, cercano, respetuoso y profesional.';
