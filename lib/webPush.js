/**
 * Web Push (notificaciones del sistema del sistema).
...
function buildPayload({ title, body, url, tag, requireInteraction, icon, badge }) {
  // Rutas same-origin (no APP_URL absoluto): si APP_URL apunta mal, Android
  // falla al cargar el ícono y muestra el Saturno cacheado del PWA.
  return {
    title: title || 'Fandez',
    body: body || '',
    icon: icon || `/icons/fandez-v11-notify.png?v=13`,
    badge: badge || `/icons/fandez-v11-badge-96.png?v=13`,
    url: url || '/',
    tag: tag || 'fandez',
