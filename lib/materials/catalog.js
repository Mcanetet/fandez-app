...
const DEFAULT_MATERIALS_CATALOG = [
  ...
  { id: 'mat-silicona', name: 'Silicona sanitaria', unit: 'tubo', marketPrice: 4500, specialtyIds: ['gasfiter', 'otros'], enabled: true },
  { id: 'mat-empaque', name: 'Empaque / o-ring', unit: 'unidad', marketPrice: 2000, specialtyIds: ['gasfiter', 'termos'], enabled: true },
  { id: 'mat-flexible', name: 'Flexible agua (par)', unit: 'par', marketPrice: 8900, specialtyIds: ['gasfiter', 'otros'], enabled: true },
  ...
  // Electrodomésticos (servicio Otros)
  { id: 'mat-filtro-lavadora', name: 'Filtro / bomba lavadora', unit: 'unidad', marketPrice: 25000, specialtyIds: ['otros', 'gasfiter'], enabled: true },
  { id: 'mat-correa', name: 'Correa lavadora', unit: 'unidad', marketPrice: 12000, specialtyIds: ['otros'], enabled: true },
  { id: 'mat-kit-sellos', name: 'Kit sellos / empaques electrodoméstico', unit: 'kit', marketPrice: 15000, specialtyIds: ['otros', 'gasfiter'], enabled: true },
  // Pintura
