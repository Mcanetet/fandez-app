...
function buildVerificationEmail({ name, code, locale = 'es' }) {
  ...
  const body = isEn
    ? `<p>Hello <strong>${name}</strong>,</p>
        ...
        <p style="font-size:28px;font-weight:bold;letter-spacing:6px;color:#0D9488;margin:20px 0">${code}</p>
        <p>It expires in 15 minutes.</p>
        <p><a href="${appUrl}/verificar-email" style="color:#0D9488">Open verification page</a></p>
    ...
    : `<p>Hola <strong>${name}</strong>,</p>
        ...
        <p><a href="${appUrl}/verificar-email" style="color:#0D9488">Abrir página de verificación</a></p>
