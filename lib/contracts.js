...
const DOCUMENT_CATALOG = {
  ...
  company_vigency: {
    ...
    hint: 'Opcional. Registro de Empresas o notaría, idealmente de los últimos 60 días.',
    required: false,
    entities: ['empresa'],
    category: 'societario'
  },
  powers_vigency: {
    ...
    hint: 'Opcional. Solo si quien firma no aparece como administrador titular.',
    required: false,
    entities: ['empresa'],
    category: 'societario'
  },
  ...
  domicilio_proof: {
    ...
    hint: 'Opcional. Boleta de servicios, arriendo o certificado de domicilio.',
    required: false,
    entities: ['natural', 'empresa'],
    category: 'tributario'
  },
  liability_insurance: {
    ...
    hint: 'Opcional, recomendada. Cobertura de daños a terceros.',
    required: false,
    entities: ['natural', 'empresa'],
    category: 'seguros'
  },
  technical_certs: {
    ...
    hint: 'Opcional. SEC, gas u otra certificación de tu oficio.',
    required: false,
    entities: ['natural', 'empresa'],
    category: 'tecnico',
    multiple: true
