...
const COMMISSION_AGREEMENT_VERSION = '3.0';
const DEFAULT_LABOR_COMMISSION_RATE = 0.15;
/** Fecha de emisión oficial de las plantillas v3.0 (YYYY-MM-DD). */
const CONTRACT_ISSUED_ON = '2026-08-20';

function formatContractIssuedDate(isoDate = CONTRACT_ISSUED_ON) {
  const raw = String(isoDate || CONTRACT_ISSUED_ON).slice(0, 10);
...
function buildPartnerContractDocument({
  ...
  const issuedAt = formatContractIssuedDate(issuedOn);
