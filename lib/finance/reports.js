...
function buildAccountingPack({ requests = [], payments = [], pricing = {}, getAllDteDocuments }) {
  ...
  completed.forEach((r) => {
    ...
    // Reclasifica: el margen Fandez queda como ingreso real; el resto pasa a pasivo socio.
  ...
  return {
    ...
    dte: {
      ...
      note: process.env.SPLIT_INVOICING === 'false'
        ...
        : 'DTE de margen Fandez se emite automáticamente al completar el servicio. El socio registra su factura de venta por su parte.',
