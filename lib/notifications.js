  ...
  'service.no_provider': (ctx) => ({
    ...
    html: `
      ...
      <p style="margin:20px 0">
        <a href="${ctx.continueUrl}" style="display:inline-block;background:#1C64B4;color:#fff;text-decoration:none;padding:11px 16px;border-radius:10px;font-weight:600;margin:0 8px 8px 0">Sí, seguir buscando</a>
