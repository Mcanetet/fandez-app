...
function getAdminStrings(t) {
  const panels = {};
  [
    'resumen', 'finanzas', 'crm', 'briefs', 'documentos', 'contratos', 'notificaciones', 'modulos', 'promos', 'cobertura',
    'servicios', 'demo', 'pagos', 'solicitudes', 'proveedores', 'reclamos', 'whatsapp', 'aland', 'florencia',
    'consumo-ia', 'mensajes', 'datos', 'usuarios', 'backups', 'equipo', 'seguridad'
  ].forEach((id) => {
  ...
  return {
    ...
    profiles: {
      ...
      'admin.mod': t('admin.profiles.admin_mod'),
    ...
    cobertura: {
      ...
      interestTitle: t('admin.cobertura.interest_title'),
      interestEmpty: t('admin.cobertura.interest_empty'),
      interestTotal: t('admin.cobertura.interest_total'),
      interestTop: t('admin.cobertura.interest_top'),
      interestRecent: t('admin.cobertura.interest_recent'),
      interestRoleClient: t('admin.cobertura.interest_role_client'),
      interestRoleProvider: t('admin.cobertura.interest_role_provider')
    },
    servicios: {
    ...
    js: {
      ...
      crmSaved: t('admin.js.crm_saved'),
      crmDeleted: t('admin.js.crm_deleted'),
      crmDeleteConfirm: t('admin.js.crm_delete_confirm')
    }
  };
}
