/**
 * Perfiles y permisos granulares del panel de administración Fandez.
...
const PERMISSIONS = {
  ...
  'solicitudes.manage': { label: 'Asignar pedidos a socios', group: 'Operaciones' },
  ...
  'informes.view': { label: 'Ver informes de agentes', group: 'Operaciones' },
  'alertas.view': { label: 'Ver mensajes alerta', group: 'Operaciones' },
  'alertas.manage': { label: 'Crear y editar mensajes alerta', group: 'Operaciones' },
  ...
  'whatsapp.view': { label: 'Ver chats', group: 'Plataforma' },
  ...
  'datos.manage': { label: 'DSAR: exportar y anonimizar datos de usuarios', group: 'Sistema' },
  'usuarios.view': { label: 'Ver clientes y socios', group: 'Sistema' },
  'usuarios.manage': { label: 'Intervenir clientes y socios (bloquear, editar, verificar)', group: 'Sistema' },
  ...
  'comercial.view': { label: 'Ver planificación comercial', group: 'Marketing' },
  'comercial.manage': { label: 'Aplicar plan comercial / precios soft launch', group: 'Marketing' },
  ...
  'openai.usage.view': { label: 'Ver consumo de tokens OpenAI', group: 'Plataforma' },
  'florencia.view': { label: 'Ver Florencia IA y agenda', group: 'Marketing' },
  'florencia.manage': { label: 'Generar y editar campañas con Florencia IA', group: 'Marketing' },
  'florencia.approve': { label: 'Aprobar o rechazar piezas de marketing', group: 'Marketing' },
  'florencia.publish': { label: 'Publicar en redes y enviar email marketing', group: 'Marketing' },
  'founder.decisions': { label: 'Decisiones founder (aprobar/publicar marketing, ASK críticos)', group: 'Administración' },
...
const BUILTIN_PROFILES = {
  ...
  operaciones: {
    ...
    permissions: [
      ...
      'informes.view', 'alertas.view', 'alertas.manage',
      'modulos.view', 'servicios.view', 'demo.view', 'notificaciones.view',
      'cobertura.view', 'cobertura.manage', 'promos.view', 'promos.manage',
      'crm.view', 'crm.manage', 'comercial.view', 'comercial.manage',
      'contratos.view', 'contratos.review', 'aland.view', 'openai.usage.view', 'mensajes.view', 'mensajes.manage',
      'usuarios.view', 'usuarios.manage', 'datos.view', 'datos.manage', 'seguridad.view'
    ],
    builtin: true
  },
  finanzas: {
  ...
  soporte: {
    id: 'soporte',
    name: 'Soporte',
    description: 'Reclamos, chats, cuentas demo e intervención de usuarios.',
    permissions: [
      'resumen.view',       'reclamos.view', 'reclamos.manage', 'whatsapp.view',
      'demo.view', 'notificaciones.view', 'datos.view', 'datos.manage', 'contratos.view',
      'solicitudes.view', 'solicitudes.manage',
      'aland.view', 'openai.usage.view', 'mensajes.view', 'mensajes.manage',
      'informes.view', 'alertas.view', 'alertas.manage',
      'usuarios.view', 'usuarios.manage', 'seguridad.view'
    ],
    builtin: true
  },
  marketing: {
    id: 'marketing',
    name: 'Marketing',
    description: 'Florencia IA y agenda editorial. No publica ni aprueba (solo founder/superadmin).',
    permissions: [
      'resumen.view', 'florencia.view', 'florencia.manage',
      'promos.view', 'promos.manage',
      'comercial.view', 'comercial.manage', 'precios.view', 'openai.usage.view',
      'informes.view', 'alertas.view', 'alertas.manage'
    ],
    builtin: true
  },
...
const ADMIN_NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'briefs', label: 'Briefs servicio', perm: 'crm.view', icon: 'doc' },
      ...
      { id: 'informes', label: 'Informes', perm: 'informes.view', icon: 'doc' },
      { id: 'alertas', label: 'Mensajes alerta', perm: 'alertas.view', icon: 'bell' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'whatsapp', label: 'Chats', perm: 'whatsapp.view', icon: 'chat' },
      { id: 'aland', label: 'Aland IA', perm: 'aland.view', icon: 'blocks' },
      { id: 'florencia', label: 'Florencia IA', perm: 'florencia.view', icon: 'chart' },
      { id: 'consumo-ia', label: 'Consumo OpenAI', perm: 'openai.usage.view', icon: 'chart' }
    ]
  },
  {
    group: 'Cumplimiento',
    groupKey: 'compliance',
    items: [
      { id: 'documentos', label: 'Boletas y facturas', perm: 'documentos.view', icon: 'doc' },
...
const PANEL_DEFAULT_PERM = {
  ...
  informes: 'informes.view',
  alertas: 'alertas.view',
  mensajes: 'mensajes.view',
  whatsapp: 'whatsapp.view',
  aland: 'aland.view',
  florencia: 'florencia.view',
  'consumo-ia': 'openai.usage.view',
  datos: 'datos.view',
...
function resolveAdminAccess(user) {
  ...
  if (user.id === 'admin-1' || user.email === 'admin@fandez.cl') {
