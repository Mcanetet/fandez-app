...
function getProviderOnboardingSteps({ hasVerificationBanner = false } = {}) {
  const steps = [
    {
      ...
      body: 'Bienvenido a Fandez Pro. Aquí gestionas disponibilidad, trabajos y reputación. El estándar Fandez es atención de nivel europeo: puntualidad, claridad y respeto al hogar.'
    }
  ];
  ...
  steps.push(
    ...
    },
    {
      ...
      title: 'Tu reputación',
      body: 'Rating y reseñas mejoran tu visibilidad. Cumple el Procedimiento de atención Fandez en cada visita.'
    },
    {
      target: '[data-tour="specialties"]',
      title: 'Tus especialidades',
      body: 'Solo recibirás trabajos de las categorías asignadas. Si necesitas ampliarlas, escribe a soporte@fandez.cl.'
    },
    {
