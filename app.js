...
/**
 * Arranque PWA (start_url): HTML mínimo + location.replace.
...
<head>
  ...
  <style>
    ...
    img{width:96px;height:96px;border-radius:22px;box-shadow:0 8px 24px rgba(196,92,20,.2)}
  </style>
  <script>
    (function () {
      var target = ${JSON.stringify(safeTarget)};
      try { sessionStorage.setItem('fandez_pwa_boot', '1'); } catch (e) {}
...
<body>
  <img src="/icons/fandez-v11-192.png?v=11" width="192" height="192" alt="Fandez" decoding="async" fetchpriority="high">
  <noscript><meta http-equiv="refresh" content="0;url=${safeTarget}"><a href="${safeTarget}">Continuar</a></noscript>
</body>
</html>`);
});
